...
var grammar = {
    ...
    {"name": "instr", "symbols": ["insr_reg_uint16", "__", "reg", "__", "uint16"], "postprocess": d => [ d[0], d[2], d[4] ]},
    ...
    {"name": "insr_reg_uint16$string$1", "symbols": [{"literal":"A"}, {"literal":"N"}, {"literal":"D"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "insr_reg_uint16", "symbols": ["insr_reg_uint16$string$1"], "postprocess": id},
    {"name": "insr_reg_uint16$string$2", "symbols": [{"literal":"O"}, {"literal":"R"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "insr_reg_uint16", "symbols": ["insr_reg_uint16$string$2"], "postprocess": id},
    {"name": "insr_reg_uint16$string$3", "symbols": [{"literal":"X"}, {"literal":"O"}, {"literal":"R"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "insr_reg_uint16", "symbols": ["insr_reg_uint16$string$3"], "postprocess": id},
    {"name": "insr_reg_uint16$string$4", "symbols": [{"literal":"B"}, {"literal":"I"}, {"literal":"C"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "insr_reg_uint16", "symbols": ["insr_reg_uint16$string$4"], "postprocess": id},
