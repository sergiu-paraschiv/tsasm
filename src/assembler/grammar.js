...
var grammar = {
    ...
    {"name": "instr", "symbols": ["instr_1_reg_int", "__", "reg", "__", "int16"], "postprocess": d => [ d[0], d[2], d[4] ]},
    {"name": "instr", "symbols": ["instr_2_reg_int", "__", "reg", "__", "int8", "__", "reg"], "postprocess": d => [ d[0], d[2], d[4], d[6] ]},
    ...
    {"name": "instr_1_reg$string$12", "symbols": [{"literal":"I"}, {"literal":"N"}, {"literal":"C"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_1_reg", "symbols": ["instr_1_reg$string$12"], "postprocess": id},
    {"name": "instr_1_reg$string$13", "symbols": [{"literal":"D"}, {"literal":"E"}, {"literal":"C"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_1_reg", "symbols": ["instr_1_reg$string$13"], "postprocess": id},
    {"name": "instr_1_reg$string$14", "symbols": [{"literal":"N"}, {"literal":"O"}, {"literal":"T"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_1_reg", "symbols": ["instr_1_reg$string$14"], "postprocess": id},
    ...
    {"name": "instr_2_reg$string$4", "symbols": [{"literal":"A"}, {"literal":"N"}, {"literal":"D"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_2_reg", "symbols": ["instr_2_reg$string$4"], "postprocess": id},
    {"name": "instr_2_reg$string$5", "symbols": [{"literal":"O"}, {"literal":"R"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_2_reg", "symbols": ["instr_2_reg$string$5"], "postprocess": id},
    {"name": "instr_2_reg$string$6", "symbols": [{"literal":"X"}, {"literal":"O"}, {"literal":"R"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_2_reg", "symbols": ["instr_2_reg$string$6"], "postprocess": id},
    {"name": "instr_2_reg$string$7", "symbols": [{"literal":"B"}, {"literal":"I"}, {"literal":"C"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_2_reg", "symbols": ["instr_2_reg$string$7"], "postprocess": id},
    ...
    {"name": "instr_1_reg_int", "symbols": ["instr_1_reg_int$string$2"], "postprocess": id},
    ...
    {"name": "instr_2_reg_int$string$1", "symbols": [{"literal":"A"}, {"literal":"D"}, {"literal":"D"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_2_reg_int", "symbols": ["instr_2_reg_int$string$1"], "postprocess": id},
    {"name": "instr_2_reg_int$string$2", "symbols": [{"literal":"S"}, {"literal":"U"}, {"literal":"B"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_2_reg_int", "symbols": ["instr_2_reg_int$string$2"], "postprocess": id},
    {"name": "instr_2_reg_int$string$3", "symbols": [{"literal":"D"}, {"literal":"I"}, {"literal":"V"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_2_reg_int", "symbols": ["instr_2_reg_int$string$3"], "postprocess": id},
    {"name": "instr_2_reg_int$string$4", "symbols": [{"literal":"M"}, {"literal":"U"}, {"literal":"L"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "instr_2_reg_int", "symbols": ["instr_2_reg_int$string$4"], "postprocess": id},
