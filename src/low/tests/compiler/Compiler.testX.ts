...
//     });
//
//     test('declare bool variable with no initial value', () => {
//         const c = new Compiler();
//
//         const res = c.run(`
//         bool x
...
//     });
//
//     test('declare bool variable with initial value', () => {
//         const c = new Compiler();
//
//         const res = c.run(`
//         bool x := true
...
//     });
//
//     test('declare bool variable and assign immediate to it', () => {
//         const c = new Compiler();
//
//         const res = c.run(`
//         bool x
...
//     });
//
//     test('cannot assign invalid type immediate constants', () => {
//         const c = new Compiler();
//
//         expect(() => {
//             c.run(`
//             int x := true
//         `);
//         }).toThrowError('Syntax error at line 2 col 22');
//
//         expect(() => {
//             c.run(`
//             bool x := 1
